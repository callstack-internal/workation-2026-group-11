...
import { classifyEmployee, resolveBand, buildRates, roundSig } from '../ingest/build-rates.js';
...
test('buildRates: matched gets a rate, unmatched is flagged, email baked as key', () => {
  const employees = [
    emp({ firstName: 'Ada', lastName: 'Lovelace', title: 'Lovelace Ada', email: 'ada.lovelace@example.test', roleTags: ['RN Dev', 'Senior 1'] }),
